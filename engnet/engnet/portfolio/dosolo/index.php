...
<body>
        ...
        <!-- TÍTULO PRINCIPAL -->
                ...
                <div class="img-titulo" >
                    <h1 id="titulo">Nome do Projeto</h1>
                </div>        
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-8">
                <div class="conteudo">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean sit amet blandit lorem. In et arcu eleifend, fringilla turpis sed, sollicitudin felis. Curabitur venenatis est viverra nisl tristique finibus. Pellentesque a porttitor neque, sed malesuada libero. Nulla pulvinar augue luctus tortor lacinia, eu lacinia ex efficitur. Nulla neque enim, vestibulum sed velit sed, pellentesque dapibus neque. Proin gravida nulla ligula, sed consequat sapien tempor eu.
                <p>
                </div>
          </div>
            <div class="col-sm-2">
