                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-heart"></i> EngNet <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="minhas-demandas.php">Minhas demandas</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <!-- Modal de edição -->
                <div class="modal fade bs-example-modal-md" id="modal-editar" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog modal-md">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" class="btn btn-primary">Marcar feito</button>
                      <button type="submit" class="btn btn-danger">Marcar não feito</button>
                    </div>
