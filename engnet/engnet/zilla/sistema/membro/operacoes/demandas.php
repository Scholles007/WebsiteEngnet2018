                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-bar-chart"></i> Operações <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="ps.php">Processo Seletivo</a></li>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <p class="text-muted font-13 m-b-30">
                    O sistema de demandas tem como objetivo agilizar os processos de demanda dentro da empresa, mantendo um histórico e todos alinhados com o que deve ser executado.
                  </p>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <tr>
                        <td>Fazer o sistema da EngNet</td>
                        <td>Fulano Paulão</td>
                        <td>Não</td>
                        <td>Vítor Soares, Bruno Scholles</td>
                        <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.soiadjsioajdioasjdiosajiodjsaidjasiojdsaiojdiosajdoiasjdiosajdas</td>
                        <td>13/10/2018</td>
                        <td>
                          <a>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                  <label>Demanda*:</label>
                                  <input type="text" maxlength="100" placeholder="O que precisa ser feito?" name="tdemanda" class="form-control" required>
                                </div>
                                <div class="form-group">
                                  <label>Descrição*:</label>
                                  <textarea rows=4 maxlength="1600" placeholder="Como deve ser feito?" type="text" name="d_demanda" class="form-control" required></textarea>
                                </div>
                                <div class="form-group">
                                  <label>Prazo*:</label>
                                    <input type="text" class="form-control" data-inputmask="'mask': '99/99/9999'" name="prazo" required>
                                    <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                                </div>
                                <div class="form-group">
                                  <label>Destino*:</label>
                                    <select class="form-control" name="destino" required>
                                      <option value="individual">Individualmente, listar participantes abaixo</option>
                                      <option value="comercial">Comercial</option>
                                      <option value="projetos">Projetos</option>
                                      <option value="operacoes">Operações</option>
                                      <option value="marketing">Marketing</option>
                                      <option value="executiva">Executiva</option>
                                      <option value="engnet">EngNet</option>
                                    </select>
                                  </div>
                                </blockquote>
                              </div>
                                  ...
                                  <div class="form-group">
                                    <label>Participante 1:</label>
                                      <select class="form-control" name="p1">
                                        ...
                                        <option value="ciclano">Ciclano soares brito</option>
                                      </select>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                  <label>PIN:</label>
                                  <input type="password" maxlength="5" placeholder="*****" name="senha" class="form-control" required>
                                </div>
                                </blockquote>
                              </div>
                            </div>
                  ...
                  <div class="modal-dialog modal-lg">
                    ...
                    <form action="teste.php" method="POST">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Visualizar | Demanda nº 000000</h4>
                      </div>
