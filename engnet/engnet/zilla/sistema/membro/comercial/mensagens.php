              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <p class="text-muted font-13 m-b-30">
                    Aqui é onde é recebido as mensagens advindas da parte 'Contato' do site, a resposta deve ser feita por fora, a partir de e-mail fornecido em cada uma das entradas.
                  </p>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Fulano Paulão</td>
                        <td>Não</td>
                        <td>Queria saber o que é uma EJ</td>
                        <td>Então, lorem ipsum ndjisadn ndan dasid dijsad dijsa jdau i aidj asn jdija da dijnas dadn dk ndd kank d kasnd sa.</td>
                        <td>oi.aaa@eae.gmail.com</td>
                        <td>
                          <a>
