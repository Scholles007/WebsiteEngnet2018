...
<head>
    ...
    <!-- Estilos Css Globais -->
    <link rel="stylesheet" href="../system/css/zilla/login.css">
...
<body>
  ...
  <video autoplay muted loop id="myVideo">
      <source src="../system/videos/fox.mp4" type="video/mp4">
  </video>
  ...
  <section class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <form action="../system/controllers/zilla/logar.php" method="POST">
            ...
            <p><a href="servico/">Solicitar um serviço</a> | <a href="../blog/">Ir para o Blog</a> |  <a href="../#contato">Voltar para o site</a></p>
